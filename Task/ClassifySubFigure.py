...
if __name__ == '__main__':
    ...
    query = 'SELECT s3.img_loc FROM s3_readable_keys as s3, image_composite as ic WHERE s3.img_id = ic.img_id AND s3.is_readable is null AND s3.img_id NOT REGEXP "PMC[0-9]+_[a-zA-Z]+[0-9]+-[0-9]+&copy" AND (s3.img_format = "jpg" OR s3.img_format = "png") AND ic.is_composite = 1 limit 50000 offset 0'
